...
<deviation_rules>
**Authoritative source:** `gsd:deviation-classifier` skill

**While executing tasks, you WILL discover work not in the plan.** This is normal.

Apply the four rules from `gsd:deviation-classifier`:

| Rule | Trigger | Action |
|------|---------|--------|
| 1 | Bug found | Auto-fix, track for Summary |
| 2 | Missing critical functionality | Auto-add, track for Summary |
| 3 | Blocking issue | Auto-fix to unblock, track |

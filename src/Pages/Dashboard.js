...
export function DashboardPage(dashboardPageInputProps) {
    let elems_8, elems_1, elems, elems_7;
    ...
    return createElement("div", createObj(ofArray([["className", "min-h-screen bg-gray-100"], (elems_8 = [createElement("header", createObj(ofArray([["className", "bg-white shadow-sm"], (elems_1 = [createElement("div", createObj(ofArray([["className", "max-w-4xl mx-auto px-4 py-4 flex items-center justify-between"], (elems = [createElement("h1", {
    ...
    })], ["children", reactApi.Children.toArray(Array.from(elems))])])))], ["children", reactApi.Children.toArray(Array.from(elems_1))])]))), createElement("main", createObj(ofArray([["className", "max-w-4xl mx-auto px-4 py-8"], (elems_7 = toList(delay(() => {
        let elems_2;
        return append(singleton(createElement("div", createObj(ofArray([["className", "flex gap-2 mb-6"], (elems_2 = [createElement("button", {
            onClick: (_arg_2) => {
            ...
            let elems_6, elems_4, elems_3, elems_5;
            return (activeTab.tag === 1) ? singleton(createElement(ProgressViewPage, {
                userId: user.id,
            })) : singleton(createElement("div", createObj(singleton_1((elems_6 = [createElement("div", createObj(ofArray([["className", "bg-white rounded-2xl shadow-sm p-6 mb-6"], (elems_4 = [createElement("h2", {
            ...
            })], ["children", reactApi.Children.toArray(Array.from(elems_3))])])))], ["children", reactApi.Children.toArray(Array.from(elems_4))])]))), createElement("div", createObj(ofArray([["className", "bg-white rounded-2xl shadow-sm p-6 text-center"], (elems_5 = [createElement(WorkoutToggle, {
                userId: user.id,

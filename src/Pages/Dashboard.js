...
import { unwrap, value as value_236, defaultArg } from "../fable_modules/fable-library-js.4.28.0/Option.js";
...
export function DashboardPage(dashboardPageInputProps) {
    let elems_26, elems_3, elems_2, elems, elems_1, elems_25;
    ...
    reactApi.useEffect(() => {
        const pr_2 = PromiseBuilder__Run_212F1D4B(promise, PromiseBuilder__Delay_62FBFDE1(promise, () => (PromiseBuilder__Delay_62FBFDE1(promise, () => (getTeamProfiles().then((_arg_7) => {
            ...
            patternInput_18[1](ofArray_1(map_1((p) => [p.id, ((p.display_name != null) && (value_236(p.display_name) !== "")) ? value_236(p.display_name) : p.member_id], profiles), {
                Compare: comparePrimitives,
            }));
            return ((matchValue_2 = tryFind((p_1) => (p_1.id === user.id), profiles), (matchValue_2 == null) ? ((setUserDisplayName(defaultArg(user.email, "사용자")), Promise.resolve())) : ((myProfile = matchValue_2, (setUserDisplayName(((myProfile.display_name != null) && (value_236(myProfile.display_name) !== "")) ? value_236(myProfile.display_name) : myProfile.member_id), (patternInput_16[1](myProfile.member_id), Promise.resolve())))))).then(() => PromiseBuilder__Delay_62FBFDE1(promise, () => (isAdmin().then((_arg_8) => {
    ...
    return createElement("div", createObj(ofArray([["className", "min-h-screen bg-gray-100"], (elems_26 = [createElement("header", createObj(ofArray([["className", "bg-white shadow-sm"], (elems_3 = [createElement("div", createObj(ofArray([["className", "max-w-4xl mx-auto px-4 py-4 pb-6 flex items-center"], (elems_2 = [createElement("div", createObj(ofArray([["className", "flex-1 flex justify-start"], (elems = toList(delay(() => (patternInput_17[0] ? singleton(createElement("button", {
        onClick: (_arg_31) => {
        ...
        children: "관리",
    })) : empty_1()))), ["children", reactApi.Children.toArray(Array.from(elems))])]))), createElement("h1", {
        className: "text-2xl font-bold text-indigo-600 whitespace-nowrap",
        children: "픽제주 헬스 클럽",
    }), createElement("div", createObj(ofArray([["className", "flex-1 flex items-center justify-end gap-2"], (elems_1 = [createElement("button", {
        onClick: (_arg_32) => {
    ...
    })], ["children", reactApi.Children.toArray(Array.from(elems_1))])])))], ["children", reactApi.Children.toArray(Array.from(elems_2))])])))], ["children", reactApi.Children.toArray(Array.from(elems_3))])]))), createElement("main", createObj(ofArray([["className", "max-w-4xl mx-auto px-4 py-8"], (elems_25 = toList(delay(() => {
        let elems_13, value_43, elems_5, elements_1, elems_10, arg_7, d, parts, arg_2, arg_3, arg_4, value_69, elems_7, elements_2, value_98, elems_9, elements_3, value_120, elems_12, elements_4;
        return append(singleton(createElement("div", createObj(ofArray([["className", "flex items-center justify-between bg-white rounded-lg shadow-sm p-4 mb-4"], (elems_13 = [createElement("button", createObj(ofArray([["onClick", (_arg_34) => {
            goToPrevMonth();
        }], (value_43 = "w-10 h-10 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center transition-colors", ["className", value_43]), (elems_5 = [createElement("svg", createObj(ofArray([["width", 20], ["height", 20], ["viewBox", (((((0 + " ") + 0) + " ") + 24) + " ") + 24], ["fill", "none"], ["stroke", "currentColor"], ["strokeWidth", 2.5], ["strokeLinecap", "round"], ["strokeLinejoin", "round"], (elements_1 = ofArray([createElement("polyline", {
            points: "14,18 8,12 14,6",
        }), createElement("polyline", {
            points: "8,18 2,12 8,6",
        })]), ["children", reactApi.Children.toArray(Array.from(elements_1))])])))], ["children", reactApi.Children.toArray(Array.from(elems_5))])]))), createElement("div", createObj(ofArray([["className", "flex items-center gap-2"], (elems_10 = [createElement("h2", {
            className: "text-lg font-semibold text-gray-800",
            children: (calendarSelectedDate == null) ? ((arg_7 = (day(now()) | 0), toText(printf("%d년 %d월 %d일"))(currentYear)(currentMonth)(arg_7))) : ((d = calendarSelectedDate, (parts = split(d, ["-"], undefined, 0), (parts.length === 3) ? ((arg_2 = item(0, parts), (arg_3 = (parse(item(1, parts), 511, false, 32) | 0), (arg_4 = (parse(item(2, parts), 511, false, 32) | 0), toText(printf("%s년 %d월 %d일"))(arg_2)(arg_3)(arg_4))))) : d))),
        }), createElement("button", createObj(ofArray([(value_69 = "w-8 h-8 rounded-full bg-indigo-100 hover:bg-indigo-200 flex items-center justify-center transition-colors text-indigo-600", ["className", value_69]), ["onClick", (_arg_35) => {
            ...
            const userId = user.id;
                ...
                reloadMonthlyWorkouts();
                                            ...
                                            ;
        }], (elems_7 = [createElement("svg", createObj(ofArray([["width", 16], ["height", 16], ["viewBox", (((((0 + " ") + 0) + " ") + 24) + " ") + 24], ["fill", "none"], ["stroke", "currentColor"], ["strokeWidth", 2], ["strokeLinecap", "round"], ["strokeLinejoin", "round"], (elements_2 = ofArray([createElement("path", {
            d: "M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z",
        }), createElement("circle", {
            cx: 12,
            cy: 13,
            r: 4,
        })]), ["children", reactApi.Children.toArray(Array.from(elements_2))])])))], ["children", reactApi.Children.toArray(Array.from(elems_7))])]))), createElement("button", createObj(ofArray([["onClick", (_arg_36) => {
            setSelectedDate(defaultArg(calendarSelectedDate, getTodayDateString()));
            setEditState(new RecordEditState(1, []));
        }], (value_98 = "w-8 h-8 rounded-full bg-green-100 hover:bg-green-200 flex items-center justify-center transition-colors text-green-600", ["className", value_98]), (elems_9 = [createElement("svg", createObj(ofArray([["width", 16], ["height", 16], ["viewBox", (((((0 + " ") + 0) + " ") + 24) + " ") + 24], ["fill", "none"], ["stroke", "currentColor"], ["strokeWidth", 2], ["strokeLinecap", "round"], ["strokeLinejoin", "round"], (elements_3 = ofArray([createElement("path", {
            d: "M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7",
        }), createElement("path", {
            d: "M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z",
        })]), ["children", reactApi.Children.toArray(Array.from(elements_3))])])))], ["children", reactApi.Children.toArray(Array.from(elems_9))])])))], ["children", reactApi.Children.toArray(Array.from(elems_10))])]))), createElement("button", createObj(ofArray([["onClick", (_arg_37) => {
            goToNextMonth();
        }], (value_120 = "w-10 h-10 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center transition-colors", ["className", value_120]), (elems_12 = [createElement("svg", createObj(ofArray([["width", 20], ["height", 20], ["viewBox", (((((0 + " ") + 0) + " ") + 24) + " ") + 24], ["fill", "none"], ["stroke", "currentColor"], ["strokeWidth", 2.5], ["strokeLinecap", "round"], ["strokeLinejoin", "round"], (elements_4 = ofArray([createElement("polyline", {
            points: "10,6 16,12 10,18",
        }), createElement("polyline", {
            points: "16,6 22,12 16,18",
        })]), ["children", reactApi.Children.toArray(Array.from(elements_4))])])))], ["children", reactApi.Children.toArray(Array.from(elems_12))])])))], ["children", reactApi.Children.toArray(Array.from(elems_13))])])))), delay(() => {
            let elems_18, elems_15, elements_5, elems_17, elements_6;
            return append(singleton(createElement("div", createObj(ofArray([["className", "flex gap-2 mb-6"], (elems_18 = [createElement("button", createObj(ofArray([["onClick", (_arg_38) => {
                setViewScope(new ViewScope(0, []));
            }], ["className", "flex-1 px-6 py-3 rounded-lg font-medium transition-colors flex items-center justify-center gap-2 " + (equals(viewScope, new ViewScope(0, [])) ? "bg-indigo-600 text-white" : "bg-gray-200 text-gray-700 hover:bg-gray-300")], (elems_15 = [createElement("svg", createObj(ofArray([["width", 20], ["height", 20], ["viewBox", (((((0 + " ") + 0) + " ") + 24) + " ") + 24], ["fill", "none"], ["stroke", "currentColor"], ["strokeWidth", 2], ["strokeLinecap", "round"], ["strokeLinejoin", "round"], (elements_5 = ofArray([createElement("path", {
            ...
            })]), ["children", reactApi.Children.toArray(Array.from(elements_5))])]))), createElement("span", {
                children: "나",
            })], ["children", reactApi.Children.toArray(Array.from(elems_15))])]))), createElement("button", createObj(ofArray([["onClick", (_arg_39) => {
                setViewScope(new ViewScope(1, []));
            }], ["className", "flex-1 px-6 py-3 rounded-lg font-medium transition-colors flex items-center justify-center gap-2 " + (equals(viewScope, new ViewScope(1, [])) ? "bg-indigo-600 text-white" : "bg-gray-200 text-gray-700 hover:bg-gray-300")], (elems_17 = [createElement("svg", createObj(ofArray([["width", 20], ["height", 20], ["viewBox", (((((0 + " ") + 0) + " ") + 24) + " ") + 24], ["fill", "none"], ["stroke", "currentColor"], ["strokeWidth", 2], ["strokeLinecap", "round"], ["strokeLinejoin", "round"], (elements_6 = ofArray([createElement("path", {
                ...
                children: "우리",
            })], ["children", reactApi.Children.toArray(Array.from(elems_17))])])))], ["children", reactApi.Children.toArray(Array.from(elems_18))])])))), delay(() => {
                let matchValue_5, elems_23;
                return append((matchValue_5 = activeTab, (matchValue_5.tag === 1) ? ((viewScope.tag === 1) ? singleton(createElement(TeamViewPage, {
                ...
                })) : ((matchValue_5.tag === 3) ? singleton(createElement(AdminPage, null)) : ((matchValue_5.tag === 4) ? singleton(createElement(ProfilePage, {
                    user: user,
                ...
                })) : singleton(createElement("div", createObj(singleton_1((elems_23 = toList(delay(() => {
                    let elems_19;
                    return append(singleton(createElement("div", createObj(ofArray([["className", "bg-white rounded-xl shadow-sm p-4 mt-4"], (elems_19 = [createElement(CalendarGrid, {
                        userId: user.id,
                        year: currentYear,
                        month: currentMonth,
                        ...
                        onDateDoubleClick: (dateString_1) => {
                            ...
                            const pr_7 = PromiseBuilder__Run_212F1D4B(promise, PromiseBuilder__Delay_62FBFDE1(promise, () => (PromiseBuilder__Delay_62FBFDE1(promise, () => {
                                let arg, arg_1;
                                const storedMsg = window.localStorage.getItem("rollbook-default-msg");
                                ...
                                const storedGoal = window.localStorage.getItem("rollbook-monthly-goal");
                                const goal = ((storedGoal == null) ? true : (storedGoal === "")) ? "20" : storedGoal;
                                const dateParts = split(dateString_1, ["-"], undefined, 0);
                                const msg = replace(replace(replace(template, "%DATE", (dateParts.length === 3) ? ((arg = (parse(item(1, dateParts), 511, false, 32) | 0), (arg_1 = (parse(item(2, dateParts), 511, false, 32) | 0), toText(printf("%d월 %d일"))(arg)(arg_1)))) : dateString_1), "%COUNT", int32ToString(workoutDaysCount + 1)), "%GOAL", goal);
                    ...
                    })], ["children", reactApi.Children.toArray(Array.from(elems_19))])])))), delay(() => {
                        let matchValue_6, date_4, grouped, elems_22;
                        return append((matchValue_6 = calendarSelectedDate, (matchValue_6 == null) ? singleton(defaultOf()) : ((date_4 = matchValue_6, (grouped = map_1((tupledArg) => {
                            ...
                            GetHashCode: stringHash,
                        })), singleton(createElement("div", createObj(ofArray([["className", "bg-white rounded-xl shadow-sm p-4 mt-4"], (elems_22 = toList(delay(() => {
                            let elems_20;
                            return (calendarDateRecords.length === 0) ? singleton(createElement("div", {
                                className: "text-center text-gray-400 py-4",
                                children: "기록이 없습니다",
                            })) : append(singleton(createElement("div", createObj(ofArray([["className", "flex flex-wrap gap-2 mb-3"], (elems_20 = toList(delay(() => collect((matchValue_7) => {
                            ...
                            }, grouped))), ["children", reactApi.Children.toArray(Array.from(elems_20))])])))), delay(() => {
                                let elems_21;
                                ...
                                if (matchValue_8 == null) {
                                    ...
                                    if (matchValue_9 == null) {
                                        ...
                                        return singleton(createElement("div", createObj(ofArray([["className", "space-y-2 pt-2 border-t"], (elems_21 = toList(delay(() => collect((record_1) => {
                                        ...
                                        }, records_9))), ["children", reactApi.Children.toArray(Array.from(elems_21))])]))));
                                    }
                                }
                            }));
                    ...
                    })) : ((matchValue_12.tag === 6) ? singleton(createElement("div", createObj(ofArray([["className", "fixed bottom-4 left-4 right-4 bg-red-100 text-red-700 p-3 rounded-lg shadow-lg z-50 text-center"], (elems_24 = [matchValue_12.fields[0], createElement("button", {
                        onClick: (_arg_47) => {
                            setEditState(new RecordEditState(0, []));
                        },
                        className: "ml-2 underline",
                        children: "닫기",
                    })], ["children", reactApi.Children.toArray(Array.from(elems_24))])])))) : singleton(defaultOf()))));
                }));
            }));
        }));
    })), ["children", reactApi.Children.toArray(Array.from(elems_25))])])))], ["children", reactApi.Children.toArray(Array.from(elems_26))])])));
}

...
import { unwrap, value as value_235, defaultArg } from "../fable_modules/fable-library-js.4.28.0/Option.js";
...
export function DashboardPage(dashboardPageInputProps) {
    let elems_25, elems_2, elems_1, elems, elems_24;
    ...
    reactApi.useEffect(() => {
        const pr_2 = PromiseBuilder__Run_212F1D4B(promise, PromiseBuilder__Delay_62FBFDE1(promise, () => (PromiseBuilder__Delay_62FBFDE1(promise, () => (getTeamProfiles().then((_arg_7) => {
            ...
            patternInput_18[1](ofArray_1(map_1((p) => [p.id, ((p.display_name != null) && (value_235(p.display_name) !== "")) ? value_235(p.display_name) : p.member_id], profiles), {
                Compare: comparePrimitives,
            }));
            return ((matchValue_2 = tryFind((p_1) => (p_1.id === user.id), profiles), (matchValue_2 == null) ? ((setUserDisplayName(defaultArg(user.email, "사용자")), Promise.resolve())) : ((myProfile = matchValue_2, (setUserDisplayName(((myProfile.display_name != null) && (value_235(myProfile.display_name) !== "")) ? value_235(myProfile.display_name) : myProfile.member_id), (patternInput_16[1](myProfile.member_id), Promise.resolve())))))).then(() => PromiseBuilder__Delay_62FBFDE1(promise, () => (isAdmin().then((_arg_8) => {
    ...
    return createElement("div", createObj(ofArray([["className", "min-h-screen bg-gray-100"], (elems_25 = [createElement("header", createObj(ofArray([["className", "bg-white shadow-sm"], (elems_2 = [createElement("div", createObj(ofArray([["className", "max-w-4xl mx-auto px-4 py-4 pb-6 flex items-center"], (elems_1 = [createElement("div", {
        className: "flex-1",
    }), createElement("h1", {
        ...
        return append(singleton(createElement("div", createObj(ofArray([["className", "flex items-center justify-between bg-white rounded-lg shadow-sm p-4 mb-4"], (elems_12 = [createElement("button", createObj(ofArray([["onClick", (_arg_34) => {
        ...
        })]), ["children", reactApi.Children.toArray(Array.from(elements_1))])])))], ["children", reactApi.Children.toArray(Array.from(elems_4))])]))), createElement("div", createObj(ofArray([["className", "flex items-center gap-2"], (elems_9 = [createElement("h2", {
            ...
            cy: 13,
            r: 4,
        })]), ["children", reactApi.Children.toArray(Array.from(elements_2))])])))], ["children", reactApi.Children.toArray(Array.from(elems_6))])]))), createElement("button", createObj(ofArray([["onClick", (_arg_36) => {
            setSelectedDate(defaultArg(calendarSelectedDate, getTodayDateString()));
            setEditState(new RecordEditState(1, []));
        }], (value_97 = "w-8 h-8 rounded-full bg-green-100 hover:bg-green-200 flex items-center justify-center transition-colors text-green-600", ["className", value_97]), (elems_8 = [createElement("svg", createObj(ofArray([["width", 16], ["height", 16], ["viewBox", (((((0 + " ") + 0) + " ") + 24) + " ") + 24], ["fill", "none"], ["stroke", "currentColor"], ["strokeWidth", 2], ["strokeLinecap", "round"], ["strokeLinejoin", "round"], (elements_3 = ofArray([createElement("path", {
            d: "M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7",
        }), createElement("path", {
            d: "M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z",
        })]), ["children", reactApi.Children.toArray(Array.from(elements_3))])])))], ["children", reactApi.Children.toArray(Array.from(elems_8))])])))], ["children", reactApi.Children.toArray(Array.from(elems_9))])]))), createElement("button", createObj(ofArray([["onClick", (_arg_37) => {
            goToNextMonth();
        }], (value_119 = "w-10 h-10 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center transition-colors", ["className", value_119]), (elems_11 = [createElement("svg", createObj(ofArray([["width", 20], ["height", 20], ["viewBox", (((((0 + " ") + 0) + " ") + 24) + " ") + 24], ["fill", "none"], ["stroke", "currentColor"], ["strokeWidth", 2.5], ["strokeLinecap", "round"], ["strokeLinejoin", "round"], (elements_4 = ofArray([createElement("polyline", {
            ...
            return append(singleton(createElement("div", createObj(ofArray([["className", "flex gap-2 mb-6"], (elems_17 = [createElement("button", createObj(ofArray([["onClick", (_arg_38) => {
                ...
                children: "나",
            })], ["children", reactApi.Children.toArray(Array.from(elems_14))])]))), createElement("button", createObj(ofArray([["onClick", (_arg_39) => {
                setViewScope(new ViewScope(1, []));
            }], ["className", "flex-1 px-6 py-3 rounded-lg font-medium transition-colors flex items-center justify-center gap-2 " + (equals(viewScope, new ViewScope(1, [])) ? "bg-indigo-600 text-white" : "bg-gray-200 text-gray-700 hover:bg-gray-300")], (elems_16 = [createElement("svg", createObj(ofArray([["width", 20], ["height", 20], ["viewBox", (((((0 + " ") + 0) + " ") + 24) + " ") + 24], ["fill", "none"], ["stroke", "currentColor"], ["strokeWidth", 2], ["strokeLinecap", "round"], ["strokeLinejoin", "round"], (elements_6 = ofArray([createElement("path", {
                ...
                return append((matchValue_5 = activeTab, (matchValue_5.tag === 1) ? ((viewScope.tag === 1) ? singleton(createElement(TeamViewPage, {
                ...
                })) : singleton(createElement("div", createObj(singleton_1((elems_22 = toList(delay(() => {
                    let elems_18;
                    return append(singleton(createElement("div", createObj(ofArray([["className", "bg-white rounded-xl shadow-sm p-4 mt-4"], (elems_18 = [createElement(CalendarGrid, {
                        userId: user.id,
                        year: currentYear,
                        month: currentMonth,
                    ...
                    })], ["children", reactApi.Children.toArray(Array.from(elems_18))])])))), delay(() => {
                        let matchValue_6, date_4, grouped, elems_21;
                        return append((matchValue_6 = calendarSelectedDate, (matchValue_6 == null) ? singleton(defaultOf()) : ((date_4 = matchValue_6, (grouped = map_1((tupledArg) => {
                            ...
                            GetHashCode: stringHash,
                        })), singleton(createElement("div", createObj(ofArray([["className", "bg-white rounded-xl shadow-sm p-4 mt-4"], (elems_21 = toList(delay(() => {
                            let elems_19;
                            return (calendarDateRecords.length === 0) ? singleton(createElement("div", {
                                className: "text-center text-gray-400 py-4",
                                children: "기록이 없습니다",
                            })) : append(singleton(createElement("div", createObj(ofArray([["className", "flex flex-wrap gap-2 mb-3"], (elems_19 = toList(delay(() => collect((matchValue_7) => {
                            ...
                            }, grouped))), ["children", reactApi.Children.toArray(Array.from(elems_19))])])))), delay(() => {
                                let elems_20;
                                ...
                                if (matchValue_8 == null) {
                                    ...
                                    if (matchValue_9 == null) {
                                        ...
                                        return singleton(createElement("div", createObj(ofArray([["className", "space-y-2 pt-2 border-t"], (elems_20 = toList(delay(() => collect((record_1) => {
                                        ...
                                        }, records_9))), ["children", reactApi.Children.toArray(Array.from(elems_20))])]))));
                                    }
                                }
                            }));
                        })), ["children", reactApi.Children.toArray(Array.from(elems_21))])])))))))), delay(() => {
                    ...
                    })) : ((matchValue_12.tag === 6) ? singleton(createElement("div", createObj(ofArray([["className", "fixed bottom-4 left-4 right-4 bg-red-100 text-red-700 p-3 rounded-lg shadow-lg z-50 text-center"], (elems_23 = [matchValue_12.fields[0], createElement("button", {
                        onClick: (_arg_47) => {
                            setEditState(new RecordEditState(0, []));
                        },
                        className: "ml-2 underline",
                        children: "닫기",
                    })], ["children", reactApi.Children.toArray(Array.from(elems_23))])])))) : singleton(defaultOf()))));
                }));
            }));
        }));
    })), ["children", reactApi.Children.toArray(Array.from(elems_24))])])))], ["children", reactApi.Children.toArray(Array.from(elems_25))])])));
}

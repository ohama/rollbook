...
import { singleton as singleton_2, ofArray } from "../fable_modules/fable-library-js.4.28.0/List.js";
...
export function PhotoUploadButton(photoUploadButtonInputProps) {
    ...
    const isUploading = (uploadState.tag === 1) ? true : (uploadState.tag === 2);
        ...
        if (!(input.files == null) && (input.files.length > 0)) {
            ...
            startImmediate(singleton.Delay(() => singleton.TryWith(singleton.Delay(() => {
                ...
                return singleton.Bind(awaitPromise(compressImage(file)), (_arg) => {
                    ...
                    return singleton.Bind(awaitPromise(upload(bucketName, path, _arg, (progress) => {
                        ...
                        if (uploadResult.tag === 1) {
                            ...
                            return singleton.Bind(awaitPromise(createSignedUrl(bucketName, uploadResult.fields[0], 3600)), (_arg_2) => {
                                const urlResult = _arg_2;
                                const finalUrl = (urlResult.tag === 1) ? "" : urlResult.fields[0];
                                const today_1 = getTodayDateString();
                                return singleton.Bind(awaitPromise(createPhotoRecord(userId, today_1, finalUrl, undefined)), (_arg_3) => {
    ...
    return createElement("div", createObj(singleton_2((elems_10 = toList(delay(() => append(singleton_1(createElement("input", {
        ...
        let elems_3, elems_6, elems_4, elems_5, elems_7, elems_9, elems_8, elems_2, value_26, elems, value_38, elems_1;
        const matchValue = uploadState;
        switch (matchValue.tag) {
            case 1:
                return singleton_1(createElement("div", createObj(ofArray([["className", "flex items-center gap-2 px-4 py-3 bg-gray-100 text-gray-500 rounded-lg cursor-wait"], (elems_3 = [createElement("span", {
            ...
            case 2: {
                ...
                return singleton_1(createElement("div", createObj(ofArray([["className", "px-4 py-3 bg-gray-100 rounded-lg"], (elems_6 = [createElement("div", createObj(ofArray([["className", "flex items-center justify-between mb-2"], (elems_4 = [createElement("span", {
                    className: "text-sm text-gray-600",
                    children: "업로드 중...",
                }), createElement("span", {
                    className: "text-sm font-medium text-indigo-600",
                    children: toText(printf("%.0f%%"))(progress_1),
                })], ["children", reactApi.Children.toArray(Array.from(elems_4))])]))), createElement("div", createObj(ofArray([["className", "w-full h-2 bg-gray-200 rounded-full overflow-hidden"], (elems_5 = [createElement("div", {
            ...
            case 3:
                return singleton_1(createElement("div", createObj(ofArray([["className", "flex items-center gap-2 px-4 py-3 bg-green-100 text-green-700 rounded-lg"], (elems_7 = [createElement("span", {
                    className: "text-xl",
                    children: "✅",
                }), createElement("span", {
            ...
            case 4:
                return singleton_1(createElement("div", createObj(ofArray([["className", "space-y-2"], (elems_9 = [createElement("div", createObj(ofArray([["className", "flex items-center gap-2 px-4 py-3 bg-red-100 text-red-700 rounded-lg"], (elems_8 = [createElement("span", {
                    className: "text-xl",
                    children: "❌",
                }), createElement("span", {
                    children: matchValue.fields[0],
                })], ["children", reactApi.Children.toArray(Array.from(elems_8))])]))), createElement("button", {
                    onClick: (_arg_7) => {
            ...
            default:
                return singleton_1(createElement("div", createObj(ofArray([["className", "flex gap-2"], (elems_2 = [createElement("button", createObj(ofArray([(value_26 = "flex items-center gap-2 px-4 py-3 bg-indigo-100 text-indigo-700 rounded-lg cursor-pointer hover:bg-indigo-200 transition-colors", ["className", value_26]), ["onClick", (_arg_5) => {
                    const el = document.getElementById("photo-camera-input");
                    if (!(el == null)) {
                        el.click();
                    }
                    ...
                    className: "font-medium",
                    children: "사진 촬영",
                })], ["children", reactApi.Children.toArray(Array.from(elems))])]))), createElement("button", createObj(ofArray([(value_38 = "flex items-center gap-2 px-4 py-3 bg-purple-100 text-purple-700 rounded-lg cursor-pointer hover:bg-purple-200 transition-colors", ["className", value_38]), ["onClick", (_arg_6) => {
                    const el_1 = document.getElementById("photo-gallery-input");
                    if (!(el_1 == null)) {
                        el_1.click();
                    }
